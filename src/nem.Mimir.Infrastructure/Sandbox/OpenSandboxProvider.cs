...
[Obsolete("OpenSandboxProvider is legacy. Use ISandboxContract via SandboxContractAdapter instead.")]
[SuppressMessage("Compiler", "CS0618", Justification = "Legacy provider remains available for backward-compatible adapter composition.")]
