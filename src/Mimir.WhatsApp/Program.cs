...
builder.Services.AddSingleton<Mimir.Application.ChannelEvents.IChannelMessageSender>(
...
builder.Services.AddMediatR(cfg =>
    cfg.RegisterServicesFromAssembly(typeof(Mimir.Application.ChannelEvents.IngestChannelEventCommand).Assembly));
