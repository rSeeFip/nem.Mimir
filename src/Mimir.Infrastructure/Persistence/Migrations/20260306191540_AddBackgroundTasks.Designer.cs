...
namespace Mimir.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260306191540_AddBackgroundTasks")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mimir.Domain.Entities.AgentMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Mimir.Domain.Entities.AuditEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Mimir.Domain.Entities.BackgroundTask", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Mimir.Domain.Entities.ChannelEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Mimir.Domain.Entities.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Mimir.Domain.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Mimir.Domain.Entities.SystemPrompt", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Mimir.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Mimir.Infrastructure.Identity.ActorIdentityDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Mimir.Infrastructure.Identity.ChannelIdentityLinkDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Mimir.Domain.Entities.Conversation", b =>
                {
                    b.OwnsOne("Mimir.Domain.ValueObjects.ConversationSettings", "Settings", b1 =>
                        {
            ...
            modelBuilder.Entity("Mimir.Domain.Entities.Message", b =>
                {
                    b.HasOne("Mimir.Domain.Entities.Conversation", null)
                        .WithMany("Messages")
                        .HasForeignKey("ConversationId")
            ...
            modelBuilder.Entity("Mimir.Infrastructure.Identity.ChannelIdentityLinkDocument", b =>
                {
                    b.HasOne("Mimir.Infrastructure.Identity.ActorIdentityDocument", "ActorIdentity")
                        .WithMany("Links")
