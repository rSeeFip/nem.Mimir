...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddApplicationServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.Configure<global::nem.Mimir.Application.Tokens.TokenBudgetGovernorOptions>(configuration.GetSection(global::nem.Mimir.Application.Tokens.TokenBudgetGovernorOptions.SectionName));
        services.AddScoped<ITokenBudgetPolicy, TokenBudgetGovernor>();
        // T30: Model Cascade
        ...
        services.Configure<global::nem.Mimir.Application.Guardrails.GuardrailsOptions>(configuration.GetSection(global::nem.Mimir.Application.Guardrails.GuardrailsOptions.SectionName));
        services.AddSingleton<IGuardrailEvaluator, GuardrailPolicyEngine>();
        services.AddSingleton<IGuardrailBundle, PermissiveBundle>();
        services.AddSingleton<IGuardrailBundle, StandardBundle>();
        services.AddSingleton<IGuardrailBundle, StrictBundle>();
