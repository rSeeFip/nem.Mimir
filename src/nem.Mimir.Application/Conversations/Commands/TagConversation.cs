...
public sealed record TagConversationCommand(Guid ConversationId, string Tag) : ICommand;

public sealed class TagConversationCommandValidator : AbstractValidator<TagConversationCommand>
{
    public TagConversationCommandValidator()
    {
...
internal sealed class TagConversationCommandHandler
{
    private readonly IConversationRepository _repository;
    private readonly ICurrentUserService _currentUserService;
    private readonly IUnitOfWork _unitOfWork;

    public TagConversationCommandHandler(
    ...
    public async Task Handle(TagConversationCommand request, CancellationToken cancellationToken)
    {
