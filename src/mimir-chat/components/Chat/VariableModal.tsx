        ...
        {updatedVariables.map((variable, index) => (
          <div className="mb-4" key={index}>
            ...
            <textarea
              ...
              className="mt-1 w-full rounded-lg border border-neutral-500 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-neutral-800 dark:border-opacity-50 dark:bg-nem-700 dark:text-neutral-100"
              style={{ resize: 'none' }}
