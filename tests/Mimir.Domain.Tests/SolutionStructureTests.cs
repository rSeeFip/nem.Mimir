...
public class SolutionStructureTests
{
    ...
    public void DomainProject_ShouldHaveNoProjectReferences()
    {
        ...
        var domainProjPath = Path.Combine(projectRoot, "src", "Mimir.Domain", "Mimir.Domain.csproj");
    ...
    public void ApplicationProject_ShouldOnlyReferenceDomainProject()
    {
        // Arrange
        var projectRoot = GetProjectRootPath();
        var appProjPath = Path.Combine(projectRoot, "src", "Mimir.Application", "Mimir.Application.csproj");
    ...
    public void InfrastructureProject_ShouldOnlyReferenceApplicationProject()
    {
        // Arrange
        var projectRoot = GetProjectRootPath();
        var infProjPath = Path.Combine(projectRoot, "src", "Mimir.Infrastructure", "Mimir.Infrastructure.csproj");
    ...
    public void ApiProject_ShouldReferenceInfrastructureAndSyncProjects()
    {
        // Arrange
        var projectRoot = GetProjectRootPath();
        var apiProjPath = Path.Combine(projectRoot, "src", "Mimir.Api", "Mimir.Api.csproj");
    ...
    public void AllSourceProjectsShouldExist()
    {
        ...
        {
            Path.Combine(projectRoot, "src", "Mimir.Domain", "Mimir.Domain.csproj"),
            Path.Combine(projectRoot, "src", "Mimir.Application", "Mimir.Application.csproj"),
            Path.Combine(projectRoot, "src", "Mimir.Infrastructure", "Mimir.Infrastructure.csproj"),
            Path.Combine(projectRoot, "src", "Mimir.Api", "Mimir.Api.csproj"),
        };
