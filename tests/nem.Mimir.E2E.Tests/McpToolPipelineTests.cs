...
public sealed class McpToolPipelineTests : IAsyncLifetime
{
        ...
        CancellationToken ct = default)
    {
        ...
        var clientManager = _factory.Services.GetRequiredService<nem.Mimir.Domain.McpServers.IMcpClientManager>();
        var config = new nem.Mimir.Domain.McpServers.McpServerConfig
        {
            Id = serverId,
            Name = $"MockMcpTestServer",
            TransportType = nem.Mimir.Domain.McpServers.McpTransportType.StreamableHttp,
            Url = _mockMcpServer.StreamableHttpUrl,
            IsEnabled = true,
        };
