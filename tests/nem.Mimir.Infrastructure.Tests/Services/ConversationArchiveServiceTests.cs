...
public sealed class ConversationArchiveServiceTests : RepositoryTestBase
{
    ...
    public async Task ArchiveInactiveConversationsAsync_ArchivesStaleConversations()
    {
        ...
        var unitOfWork = new nem.Mimir.Infrastructure.Persistence.UnitOfWork(Context);
        ...
        var testUnitOfWork = new nem.Mimir.Infrastructure.Persistence.UnitOfWork(testContext);
