...
public sealed class CursorTrackingTests : IDisposable
{
    ...
    private static HubFixture CreateHubFixture(AutomergeDocumentStore store, string connectionId, Guid userId, string userName)
    {
        ...
        existingUsers[connectionId] = (userId, userName);
    ...
    private static ConcurrentDictionary<string, (Guid UserId, string? UserName)> GetConnectionUsersState()
    {
        ...
        return (ConcurrentDictionary<string, (Guid UserId, string? UserName)>)(field.GetValue(null)
