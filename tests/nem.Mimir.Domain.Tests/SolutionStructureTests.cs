...
public class SolutionStructureTests
{
    ...
    public void InfrastructureProject_ShouldOnlyReferenceApplicationProject()
    {
        ...
        projectReferences.ShouldContain(r => r.ToLower().Contains("knowhub.enhancement.abstractions"));
        projectReferences.ShouldContain(r => r.ToLower().Contains("knowhub.enhancement.distillation"));
        projectReferences.ShouldContain(r => r.ToLower().Contains("knowhub.enhancement.graphrag"));
        projectReferences.ShouldContain(r => r.ToLower().Contains("knowhub.enhancement.graph"));
